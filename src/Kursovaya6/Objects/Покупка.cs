...
namespace IIS.Kursovaya6
{
    ...
    [MasterViewDefineAttribute("ПокупкаE", "Остаток", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Номер")]
    ...
    public class Покупка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya6.ЦенноваяСтела fЦенноваяСтела;
        
        private IIS.Kursovaya6.Остаток fОстаток;
        
        private IIS.Kursovaya6.БазаКлиента fБазаКлиента;
        ...
        [PropertyStorage(new string[] {
                "БазаКлиента"})]
        [NotNull()]
        public virtual IIS.Kursovaya6.БазаКлиента БазаКлиента
        {
            get
            {
                ...
                IIS.Kursovaya6.БазаКлиента result = this.fБазаКлиента;
        ...
        [PropertyStorage(new string[] {
                "Остаток"})]
        [NotNull()]
        public virtual IIS.Kursovaya6.Остаток Остаток
        {
            get
            {
                ...
                IIS.Kursovaya6.Остаток result = this.fОстаток;
        ...
        [PropertyStorage(new string[] {
                "ЦенноваяСтела"})]
        [NotNull()]
        public virtual IIS.Kursovaya6.ЦенноваяСтела ЦенноваяСтела
        {
            get
            {
                ...
                IIS.Kursovaya6.ЦенноваяСтела result = this.fЦенноваяСтела;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПокупкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПокупкаE", typeof(IIS.Kursovaya6.Покупка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПокупкаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПокупкаL", typeof(IIS.Kursovaya6.Покупка));
                }
            }
        }
    }
